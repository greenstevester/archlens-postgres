...
Deterministic checks run by `db_review.py`. Each finding states what the schema allows today, why it hurts, and the smallest change that fixes it. The LLM review pass (see SKILL.md) builds on top of these.
